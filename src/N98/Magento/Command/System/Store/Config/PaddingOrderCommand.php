...
class PaddingOrderCommand extends AbstractMagentoCommand
{
    protected function configure()
    {
        $this
            ->setName('sys:store:config:order:padding')
            ->setDescription('Set store order padding length')
            ->addArgument('padding', InputArgument::REQUIRED, 'Padding')
	...
	$padding = (int)$this->input->getArgument('padding');
	...
	SET t.increment_pad_length=$padding
